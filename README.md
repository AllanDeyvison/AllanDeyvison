...
🧑‍💻 Desenvolvedor Júnior com mais de um ano de experiência em criação de aplicações web e APIs front e back-end. Atuei profissionalmente em ambientes ágeis com metodologias como o SCRUM, participando de Squads focadas na entrega de soluções reais para clientes.

💼 Destaque para minha atuação na Stefanini, onde desenvolvi um microsserviço de captação e validação de arquivos bancários utilizando **Java e Spring Boot**, além de participar da modernização de sistemas legados.
